...
from .database_settngs import get_db_mongo
from bson.objectid import ObjectId

article_collection = get_db_mongo(collection="articles")

# Create a new articles into to the database
...
# Delete a articles from the database
...
# Get all articles present in the database
